    ...
    return (
        <div className="px-[10vw] relative mx-auto my-4 flex flex-col items-center justify-center">
            ...
            <div className="px-4 pb-10  md:pb-20 md:py-2">
                ...
                >
                    <button className="w-60 transform rounded-full bg-[#4c52ff] px-6 py-2 font-medium text-white transition-all duration-300 hover:-translate-y-0.5 hover:bg-gray-800 dark:bg-white dark:text-black dark:hover:bg-gray-200"
                    ...
                    <button className="w-60 transform rounded-full border border-[#4c52ff] bg-white px-6 py-2 font-medium text-[#4c52ff] transition-all duration-300 hover:-translate-y-0.5 hover:bg-gray-100 dark:border-gray-700 dark:bg-black dark:text-white dark:hover:bg-gray-900"
                    onClick={()=>window.location.href = 'https://docs.google.com/forms/d/e/1FAIpQLSdTQxCo1LnQxyAXNFFl6IMQHKxYJPBkoFBWQcVwMW3mzEmR3w/viewform'}>
                        Contact Support
                    </button>
                </motion.div>
                ...
                >
                    ...
                    <div className="relative overflow-hidden rounded-3xl">
                        ...
                        <div className="relative z-0 border border-neutral-200 bg-neutral-100 shadow-md dark:border-neutral-800 dark:bg-neutral-900">
                            <img
                        ...
                        <div className="pointer-events-none absolute bottom-0 left-0 z-10 h-32 w-full bg-gradient-to-t from-white to-transparent dark:from-neutral-900" />
                    </div>
                </motion.div>
